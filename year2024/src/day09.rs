...
fn read(idx: usize) -> Vec<u8> {
    let input = read_input(module_path!()).unwrap();

    let input = [input.as_str(), "2333133121414131402"][idx];
...
mod tests {
    ...
    #[test]
    fn test() {
        assert_eq!(part1(1), "1928");
        // assert_eq!(part1(0), "6365660124667");

        assert_eq!(part2(1), "2858");
        // assert_eq!(part2(0), "6390711902359");
    }
}
